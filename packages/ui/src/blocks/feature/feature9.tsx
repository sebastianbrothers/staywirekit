        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="pt-12 w-full">
            ...
            >
              ...
              <div
                aria-label="owner side preview"
                className="bg-muted absolute left-0 top-0 z-10 w-full h-full aspect-video rounded-2xl select-none border"
                style={{
                  clipPath: "inset(0 0 0 " + inset + "%)",
                }}
              />
              <div
                aria-label="resident side preview"
                className="bg-foreground absolute left-0 top-0 w-full h-full aspect-video rounded-2xl select-none border"
              />
            </div>
          </div>
        </div>
